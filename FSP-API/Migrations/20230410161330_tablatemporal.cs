...
{
    /// <inheritdoc />
    public partial class tablatemporal : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Descripcionanimal = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false)
                        ...
                        .Annotation("SqlServer:TemporalPeriodEndColumnName", "PeriodEnd")
                        .Annotation("SqlServer:TemporalPeriodStartColumnName", "PeriodStart"),
                    ImagenAnimal = table.Column<string>(type: "nvarchar(max)", nullable: false)
                        .Annotation("SqlServer:IsTemporal", true)
                        .Annotation("SqlServer:TemporalHistoryTableName", "TemporalHistory")
                        .Annotation("SqlServer:TemporalHistoryTableSchema", null)
                        .Annotation("SqlServer:TemporalPeriodEndColumnName", "PeriodEnd")
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Temporal", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Temporal_AnimalesCatalogos_AnimalesCatalogoId",
                        column: x => x.AnimalesCatalogoId,
                        principalTable: "AnimalesCatalogos",
                        principalColumn: "AnimalesCatalogoId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Temporal_ModeloUsuarios_ModeloUsuarioId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Temporal_AnimalesCatalogoId",
                table: "Temporal",
                column: "AnimalesCatalogoId");

            migrationBuilder.CreateIndex(
                name: "IX_Temporal_ModeloUsuarioId",
                table: "Temporal",
